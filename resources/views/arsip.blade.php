...
@section('content')
    ...
    <div class="p-4 mt-12 sm:ml-64 main-content-container">
        <div class="mt-4 p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
            <h2 class="text-2xl font-semibold mb-4">ARSIP SURAT</h2>
            <h3 class="mt-1 text-sm font-normal text-gray-500">Berikut ini adalah surat-surat yang telah terbit dan diarsipkan. <h3>
                    <h3 class="mt-1 text-sm font-normal text-gray-500">Klik "Lihat" pada kolom aksi untuk menampilkan surat.<h3>
                    <p></p>
            <div class="pb-4 bg-white">
                ...
                <div class="relative mt-1 flex">
                    ...
                    <input type="text" id="table-search"
                        ...
                        placeholder="Cari berdasarkan judul arsip">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('arsip.show', $arsip->id) }}"
                                    class="mr-5 font-medium text-green-400 hover:underline">Lihat</a>
