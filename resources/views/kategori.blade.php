...
@extends('admin')
@section('content')
    <div class="p-4 mt-12 sm:ml-64 dark:bg-slate-700">
        <div class="mt-4 p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
            <h2 class="text-2xl font-semibold mb-4">KATEGORI SURAT</h2>
            <h3 class="mt-1 text-sm font-normal text-gray-500">Berikut ini adalah kategori yang bisa digunakan untuk melabeli surat. <h3>
                    <h3 class="mt-1 text-sm font-normal text-gray-500"> Klik "Tambah Kategori" pada kolom aksi untuk menambahkan kategori baru.<h3>
                    <p></p>
