...
@section('content')
    <div class="p-4 mt-12 sm:ml-64">
        <div class="mt-4 p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
            <h2 class="text-2xl font-semibold mb-4">Arsip Surat >> Unggah</h2>
            <h3 class="mt-1 text-sm font-normal text-gray-500"> Unggah surat yang telah diterbitkan pada form ini untuk diarsipkan. <h3>
                    <h3 class="mt-1 text-sm font-normal text-gray-500"> Gunakan file berformat PDF. <h3>
                    <p></p>
